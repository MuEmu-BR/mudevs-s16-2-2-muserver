...
function GetSkillDamageTypeBYClass(aIndex,skill)
	...
	elseif(Class == CLASS_DW or Class == CLASS_MG or Class == CLASS_SU or Class == CLASS_RW or Class == CLASS_GC) then
...
function SkillHeal(aIndex,bIndex,SkillIndex)	-- SKILL_HEAL
...
function SkillGreaterDefense(aIndex,bIndex,SkillIndex)	-- SKILL_GREATER_DEFENSE
...
function SkillGreaterDamage(aIndex,bIndex,SkillIndex)	-- SKILL_GREATER_DAMAGE
...
function SkillPartyHeal(aIndex,SkillIndex) -- SKILL_PARTY_HEAL
...
function SkillBless(aIndex,bIndex,SkillIndex) -- SKILL_BLESS
